...
-- SELECT COUNT(titulos_mundiais) FROM pilotos;
-- SELECT titulos_mundiais FROM pilotos ORDER BY titulos_mundiais ASC;
-- SELECT titulos_mundiais FROM pilotos ORDER BY titulos_mundiais DESC;
SELECT id_piloto  FROM pilotos ORDER BY id_piloto  DESC;
